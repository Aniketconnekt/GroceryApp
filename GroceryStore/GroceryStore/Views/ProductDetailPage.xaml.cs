    ...
    public partial class ProductDetailPage : ContentPage
    {
        ...
        public ProductDetailPage(Product product)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    old_price.Text = "Rs " + product.price;
                    special_price.Text = "Rs " + product.special_price;
                }
            ...
            try
            {
                ...
                if (image.GestureRecognizers.Count > 0)
                {
                    ...
                    if (quantityItem > 1)
                    {
                        ...
                        b_price.Text = "Rs " + Math.Round((quantityItem * priceItem), 2);
                    }
                }
            }
            catch (Exception ex)
        ...
        private void weight_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                b_price.Text = "Rs " + Math.Round((int.Parse(quantity.Text) * priceItem), 2);
                price.Text = "Rs " + Math.Round(priceItem, 2);
            }
            catch (Exception ex)
            {

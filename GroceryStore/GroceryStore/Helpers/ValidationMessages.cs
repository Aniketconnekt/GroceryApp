...
namespace GroceryStore.Helpers
{
    public class ValidationMessages
    {
        ...
        public static string PhoneNumberMaximum = "Maximum 10 digits required for  Phone Number";
        public static string TermsAccept = "Please accept terms and conditions";
        public static string TotalFixed = "Minimum order amount should be Rs. ";
        ...
        public static string PincodeMinimum = "Minimum 6 digits required for Pincode";
